                        ...
                        <div className="flex flex-col bg-shadow space-y-4 overflow-y-auto rounded-lg shadow-md h-full p-4">
                            {currentChat.map((chat, index) => (
                                <div
                                    ...
                                    <div className="p-2 rounded-lg flex bg-hover_highlight text-primary_text self-end">
                                        {chat.message}
                                    </div>
                                    {chat.response && (
                            ...
                            {fetching && (
                                <div className="animate-ping mt-2 h-4 w-4 rounded-full bg-highlight self-start"></div>
                            )}
                            {error && (
                                <div className=" text-red-400">
                                    Oops! Something went wrong while fetching
                                    the response. Please try again in a moment.
                                    If the problem persists, check your internet
                                    connection or contact support for
                                    assistance.
                                </div>
                            )}
                        </div>
